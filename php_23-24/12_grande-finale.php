...
<body>
    ...
    <form method="post">
        ...
        <p>
            ...
            <input <?php if($_SERVER['REQUEST_METHOD'] == 'POST' AND empty($_POST['name'])) { echo 'class="error"'; } ?>
        ...
        <p>
            ...
            <input
                <?php if($_SERVER['REQUEST_METHOD'] == 'POST' AND empty($_POST['strasse'])) { echo 'class="error"'; } ?>type="text"
        ...
        <p>
            ...
            <input
                <?php if($_SERVER['REQUEST_METHOD'] == 'POST' AND empty($_POST['plz'])) { echo 'class="error"'; } ?>type="text"
                id="plz" name="plz" maxlength="5">
        ...
        <p>
            ...
            <input
                <?php if($_SERVER['REQUEST_METHOD'] == 'POST' AND empty($_POST['ort'])) { echo 'class="error"'; } ?>type="text"
                id="ort" name="ort">
        </p>
